...
INSERT INTO `article` (`title`, `content`, `creator`, `updater`) VALUES ('标题1', '第1版的内容', 'me', 'me');
UPDATE `article` SET `is_enabled` = 1 WHERE `id` = 1;

INSERT INTO `article_history` (`article_id`, `title`, `content`, `version_num`, `is_enabled`, `updater`, `update_time`)
SELECT `id` AS `article_id`, `title`, `content`, `version_num`, `is_enabled`, `updater`, `update_time` FROM `article` WHERE `id` = 1;
