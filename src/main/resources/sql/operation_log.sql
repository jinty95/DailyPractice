...
CREATE TABLE `operation_log_detail` (
	...
	`original_value` VARCHAR(255) DEFAULT NULL COMMENT '字段原值',
	`current_value` VARCHAR(255) DEFAULT NULL COMMENT '字段当前值',
	`create_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
	PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `operation_log_detail`(`operation_log_id`, `column_name`, `column_comment`, `original_value`, `current_value`) VALUES(1, 'id', '主键ID', NULL, 1);
INSERT INTO `operation_log_detail`(`operation_log_id`, `column_name`, `column_comment`, `original_value`, `current_value`) VALUES(1, 'col', '某字段', NULL, 'xxx');
INSERT INTO `operation_log`(`user_id`, `user_name`, `operation_type`, `table_name`, `table_comment`) VALUES('1', 'admin', 'UPDATE', 'tbl', '某表');
INSERT INTO `operation_log_detail`(`operation_log_id`, `column_name`, `column_comment`, `original_value`, `current_value`) VALUES(2, 'col', '某字段', 'xxx', 'yyy');
INSERT INTO `operation_log`(`user_id`, `user_name`, `operation_type`, `table_name`, `table_comment`) VALUES('1', 'admin', 'DELETE', 'tbl', '某表');
INSERT INTO `operation_log_detail`(`operation_log_id`, `column_name`, `column_comment`, `original_value`, `current_value`) VALUES(3, 'id', '主键ID', 1, NULL);
INSERT INTO `operation_log_detail`(`operation_log_id`, `column_name`, `column_comment`, `original_value`, `current_value`) VALUES(3, 'col', '某字段', 'yyy', NULL);
