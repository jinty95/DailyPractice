...
INSERT INTO `operation_log_detail`(`operation_log_id`, `column_name`, `column_comment`, `old_value`, `new_value`) VALUES(1, 'id', '主键ID', NULL, 1);
...
INSERT INTO `operation_log_detail`(`operation_log_id`, `column_name`, `column_comment`, `old_value`, `new_value`) VALUES(3, 'id', '主键ID', 1, NULL);
